...
namespace XVReborn
{
    ...
    public partial class Form1 : Form
    {
        ...
        {
            if (Directory.Exists("C:\\Games\\DB Xenoverse"))
            {
                if (!Directory.Exists("C:\\Games\\DB Xenoverse\\data"))
                    Directory.CreateDirectory("C:\\Games\\DB Xenoverse\\data");
                Properties.Settings.Default.datafolder = "C:\\Games\\DB Xenoverse\\data";

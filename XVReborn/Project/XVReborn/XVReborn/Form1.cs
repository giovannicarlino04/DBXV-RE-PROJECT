...
namespace XVReborn
{
    ...
    public partial class Form1 : Form
    {
        ...
        public void Form1_Load(object sender, EventArgs e)
        {
            ...
            {
                ZipFile.ExtractToDirectory(Application.StartupPath + @"\Resources\scripts.zip", Properties.Settings.Default.flexsdkfolder + @"\bin");
            }
            ...
            foreach (string arg in args)
            {
                if (arg.EndsWith(".x1m"))
                {
                    if(MessageBox.Show("Do you want to install this mod?", "Mod Installation", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.Yes)
                    {

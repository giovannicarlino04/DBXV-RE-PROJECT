...
public:
	...
	bool SetByte(const std::string &name, uint8_t byte, unsigned int row=0);
	bool SetWord(const std::string &name, uint16_t word, unsigned int row=0);
	bool SetDword(const std::string &name, uint32_t dword, unsigned int row=0);
	bool SetQword(const std::string &name, uint64_t qword, unsigned int row=0);
	bool SetFloat(const std::string &name, float f, unsigned int row=0);
	bool SetString(const std::string &name, const std::string &str, unsigned int row=0);
    bool SetBlob(const std::string &name, uint8_t *blob, unsigned int blob_size, unsigned int row=0, bool take_ownership=false);

...
using XVModsInstaller.Properties;
using static System.Reflection.Metadata.BlobBuilder;

namespace XVModsInstaller
{

    public partial class XVModsInstaller : Form
    {

        string datapath;
        string tempPath = "C:/XVRebornTemp";
        string XVRebornFolder = Application.StartupPath + @"/XVReborn";
